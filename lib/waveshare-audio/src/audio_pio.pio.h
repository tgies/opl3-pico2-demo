...
static const uint16_t audio_pio_program_instructions[] = {
    ...
    0x80a0, //  2: pull   block
    0x200f, //  3: wait   0 gpio, 15
    0x2090, //  4: wait   1 gpio, 16
    0xe02f, //  5: set    x, 15
    0x2010, //  6: wait   0 gpio, 16
    0x6001, //  7: out    pins, 1
    0x2090, //  8: wait   1 gpio, 16
    0x0046, //  9: jmp    x--, 6
    0x208f, // 10: wait   1 gpio, 15
    0x2090, // 11: wait   1 gpio, 16
    0xe02f, // 12: set    x, 15
    0x2010, // 13: wait   0 gpio, 16
    0x6001, // 14: out    pins, 1
    0x2090, // 15: wait   1 gpio, 16
    0x004d, // 16: jmp    x--, 13
    0x0002, // 17: jmp    2
            //     .wrap
};
...
static const uint16_t read_pio_program_instructions[] = {
            //     .wrap_target
    0x208f, //  0: wait   1 gpio, 15
    0x200f, //  1: wait   0 gpio, 15
    ...
    0x4001, //  6: in     pins, 1
    0x0044, //  7: jmp    x--, 4
    0x208f, //  8: wait   1 gpio, 15
    0x2090, //  9: wait   1 gpio, 16
    0xe02f, // 10: set    x, 15
    0x2010, // 11: wait   0 gpio, 16
    0x2090, // 12: wait   1 gpio, 16
    0x4001, // 13: in     pins, 1
    0x004b, // 14: jmp    x--, 11
    0x0001, // 15: jmp    1
            //     .wrap
